...
export default function Profile() {
  ...
  } = useCategories(profileId);
  const {
    currencies: userCurrencies,
    loading: ucLoading,
    addCurrency,
    removeCurrency,
  } = useUserCurrencies(user?.id);
  ...
  return (
    <Box sx={{ bgcolor: "background.default", minHeight: "100dvh" }}>
          ...
          <CardContent sx={{ p: 2.5 }}>
            ...
            {profileLoading ? (
              ...
              >
                <Typography
                  variant="body1"
                  color={profile?.username ? "text.primary" : "text.disabled"}
                >
                  ...
                  <Box key={uc.currency_code}>
                    <ListItem disablePadding sx={{ py: 0.75 }}>
                      <ListItemText
                        ...
                        secondary={
                          allCurrencies.find((c) => c.code === uc.currency_code)
                            ?.name
                        }
                  ...
                  <Box key={c.id}>
                    <ListItem disablePadding sx={{ py: 0.75 }}>
                      <ListItemText
                        ...
                        secondary={
                          c.classification
                            ? EXPENSE_CLASS_OPTIONS.find(
                                (o) => o.value === c.classification,
                              )?.label
                            : undefined
                        }
                        primaryTypographyProps={{ fontWeight: 600 }}
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            disabled={!newCurrencyCode || addingCurrency}
          >
            {addingCurrency ? (
              <CircularProgress size={20} color="inherit" />
            ) : (
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2">
            ¿Eliminás la cuenta "{deleteAccountTarget?.name}"? Los gastos
            asociados no se eliminarán pero quedarán sin cuenta.
          </Typography>
        </DialogContent>
        <DialogActions>
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2">
            ¿Eliminás la categoría &quot;{deleteCategoryTarget?.name}&quot;? Los
            gastos asociados no se eliminarán pero quedarán sin categoría.
          </Typography>
        </DialogContent>
        <DialogActions>
